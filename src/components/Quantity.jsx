...
const Quantity = ({ product, quantity, setQuantity, inCart = false }) => {
    ...
    const handleIncrease = () => {
        product.stock > quantity && setQuantity((prevValue) => prevValue + 1);
    };
        ...
        <div className='flex items-center  space-x-2 '>
            ...
            <div className={`${!inCart && 'py-2 px-3 ml-3'}`}>
                <div className="flex items-center gap-x-1.5">
                    ...
                    <input className="p-0 w-5 lg:w-6 bg-transparent border-0 text-textColor text-center " type="text" value={quantity} onChange={(e) => setQuantity(e.target.value)} />
